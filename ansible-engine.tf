...
resource "aws_instance" "ansible-engine" {
  ami           = var.aws_ami_id #"ami-0889a44b331db0194"
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo 'ansible-engine ansible_host=${aws_instance.ansible-engine.private_ip} ansible_connection=local' >> /home/ec2-user/inventory",
